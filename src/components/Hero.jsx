    ...
    <section id="hero" className="hero-stage">
      <div className="site-container relative flex min-h-[100svh] flex-col items-center justify-center pt-16 lg:min-h-[1000px]">
        <div className="w-full">
          <div className="anim-block hero-anim mx-auto max-w-3xl text-center">
            <div className="anim-slide-up">
              <h1 className="anim-slide-up-el text-[38px] font-semibold leading-[1.02] tracking-[-0.03em] text-white xs:text-[44px] sm:text-6xl lg:text-[92px]">
            ...
            <div className="anim-slide-up mt-8 sm:mt-12 sm:flex sm:justify-center" style={{ "--anim-delay": "0.12s" }}>
              <div className="anim-slide-up-el w-full sm:w-auto">
                <Button
                  href={link}
                  size="md"
                  variant="accentFill"
