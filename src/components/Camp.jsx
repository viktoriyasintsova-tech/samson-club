  ...
  return (
    <section id="camp" className="section-pad relative bg-[#f4f4f2] text-[#141414]">
      <div className="site-container">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          <div className="anim-block">
            <div className="anim-slide-up">
              <p className="anim-slide-up-el text-xs font-semibold uppercase tracking-[0.24em] text-[#E4002B]">
                Ежегодные выезды
              </p>
            </div>
          </div>

          <div className="anim-block" style={{ "--anim-delay": "0.08s" }}>
            <div className="anim-slide-up">
              <h2 className="anim-slide-up-el mt-4 text-3xl font-bold tracking-tight xs:text-4xl sm:text-5xl lg:text-6xl">
                Спортивные сборы
              </h2>
            </div>
          </div>

          <div className="anim-block" style={{ "--anim-delay": "0.14s" }}>
            <div className="anim-slide-up">
              <div
                className="anim-slide-up-el mt-8 flex w-full max-w-[320px] rounded-full border border-black/10 bg-white p-1 shadow-sm"
                role="tablist"
        ...
        <div className="anim-block" style={{ "--anim-delay": "0.2s" }}>
          <div className="anim-slide-up">
            <div
              key={season}
              className="season-panel anim-slide-up-el mx-auto mt-12 max-w-3xl rounded-3xl border border-black/10 bg-white p-6 text-center shadow-sm sm:p-10"
            >
              {isSummer ? (
                <>
