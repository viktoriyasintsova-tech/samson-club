    ...
    <section id="coach" className="section-pad">
      <div className="site-container">
        ...
        <div className="grid items-stretch gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="reveal reveal-zoom relative overflow-hidden rounded-3xl border border-white/10">
            <img
              src={coach.image}
              alt={coach.name}
          ...
          <div className="reveal glass flex flex-col justify-center rounded-3xl border-[#E4002B]/35 p-6 sm:p-8 lg:p-10" style={{ transitionDelay: "0.12s" }}>
